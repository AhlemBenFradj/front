...
export function MapChart({ setTooltipCot }) {
          ...
          geographies.map(geo => {
            ...
            return (
              <Geography
                key={geo.rsmKey}
                geography={geo}
                // fill={cur ? colorScale(cur.unemployment_rate) : "#a8c9f7" }
                style={{
                  default: {
                    fill: ['#0162e8'],
                    outline: "none"
...
export function UsaMap() {
  ...
  return (
    <div>
      <MapData setTooltipCot={setContent1} />
      <ReactTooltip>{content1}</ReactTooltip>
    </div>
  );
}
