...
import { Col, Row, Card, Dropdown, DropdownButton } from "react-bootstrap";
...
export class FullCalenderComponent extends Component {
        ...
        <Row>
          <Col md={12}>
            <Card>
              ...
              <Card.Body>
                <Row>
                  <Col md={12} sm={12} lg={3} className="animated fadeIn p-4 demo-app">

                    <div id="external-events" style={{ padding: "10px", width: "100%", height: "auto", maxHeight: "-webkit-fill-available" }}>
                    ...
                    <div className="mt-5">
                      ...
                      <Card className="border p-0 pt-3">
                        <Card.Body className="pt-3">
                          <Dropdown>
                            ...
                            <Dropdown.Menu>
                              <Dropdown.Item ><i className="fe fe-edit me-1"></i> Shedule Date</Dropdown.Item>
                              <Dropdown.Item ><i className="fe fe-trash-2 me-1"></i> Delete</Dropdown.Item>
                            </Dropdown.Menu>
                          </Dropdown>
                        ...
                        <Card.Footer>
                          <div className="media media-xs overflow-visible">
                            <img className="avatar brround avatar-md me-3" src={Imagesdata("faces2")} alt="avatar-img" />
                            <div className="media-body valign-middle">
                              <Link to={`${import.meta.env.BASE_URL}pages/profile`} className=" fw-semibold text-dark">John Paige</Link><br />
                              <Link to={`${import.meta.env.BASE_URL}pages/profile`} className="text-muted mb-0"> View client profile</Link>
                            </div>
                          </div>
                        </Card.Footer>
                      </Card>
                      <Card className="border p-0 pt-3">
                        ...
                        <Card.Footer>
                          <div className="media media-xs overflow-visible">
                            <img className="avatar brround avatar-md me-3" src={Imagesdata("faces1")} alt="avatar-img" />
                            <div className="media-body valign-middle">
                              <Link to={`${import.meta.env.BASE_URL}pages/profile`} className=" fw-semibold text-dark">Mozelle Belt</Link><br />
                              <Link to={`${import.meta.env.BASE_URL}pages/profile`} className="text-muted mb-0"> View client profile</Link>
                            </div>
                          </div>
                        </Card.Footer>
                  ...
                  <Col md={12} lg={9} className="demo-app-calendar" id="mycalendartest">
