...
export const BarGroupedOptions = {
    indexAxis: 'y',
    elements: {
        bar: {
            borderWidth: 2,
...
export function DataAttr() {
    ...
    return (<ReactECharts className="chartsh " option={option} height="350px" />);
};
...
//*** Sparkline data ***//
//Line Chart
export class LineChart1 extends Component {
    constructor(props) {
        super(props);
...
export class ColoredLineChart extends Component {
    constructor(props) {
        super(props);
...
export class AreaChart2 extends Component {
    constructor(props) {
        super(props);
...
export class ColoredAreaChart extends Component {
    constructor(props) {
        super(props);
...
export class ColoredBarChart extends Component {
    constructor(props) {
        super(props);
...
export class StackedBarChart2 extends Component {
    constructor(props) {
        super(props);
...
export class ColoredStackedBarChart extends Component {
    constructor(props) {
        super(props);
...
export class ColoredDonutChart extends Component {
    constructor(props) {
        super(props);
...
export class Sparklinedata extends Component {
    constructor(props) {
        super(props);
