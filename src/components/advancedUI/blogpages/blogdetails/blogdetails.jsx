...
import { LightboxGalleryChat2 } from '../../../../common/LightGallery';
			...
			<Row>
				<Col xxl={9} xl={12} lg={12} md={12}>
					<Card className="overflow-hidden">
						<div className="item7-card-img px-4 pt-4">
							<img src={Imagesdata("photos27")} alt="img" className="cover-image rounded-7 w-100" />
						</div>
						<Card.Body>
						...
						<Card.Footer className="pb-2 pt-2">
							<div className="item7-card-desc d-md-flex">
								<div className="d-flex align-items-center mt-0">
									<img src={Imagesdata("photos11")} className="avatar brround avatar-md me-3" alt="avatar-img" />
									<div>
							...
							<Card.Body>
								<div className="d-sm-flex mt-0 p-3 sub-review-section border border-bottom-0 br-bl-0 br-br-0">
									<div className="d-flex me-3">
										<Link to="#"><img className="media-object brround avatar-md" alt="64x64" src={Imagesdata("faces1")} /> </Link>
									</div>
									<div className="media-body">
										<h5 className="mt-0 mb-1 font-weight-semibold">Joanne Scott
											<OverlayTrigger className="tx-14 ms-0" placement="top" overlay={<Tooltip >Verified</Tooltip>}><i className="fe fe-check-circle text-success tx-12"></i></OverlayTrigger>
											<span className="tx-14 ms-2"> 4.5 <i className="fa fa-star text-warning"></i></span>
										</h5>
								...
								<div className="d-sm-flex p-3 sub-review-section border subsection-color br-tl-0 br-tr-0">
									<div className="d-flex me-3">
										<Link to="#"><img className="media-object brround avatar-md" alt="64x64" src={Imagesdata("faces3")} /> </Link>
									</div>
									<div className="media-body">
										<h5 className="mt-0 mb-1 font-weight-semibold">Rose Slater <OverlayTrigger className="tx-14 ms-0" placement="top" overlay={<Tooltip >Verified</Tooltip>}><i className="fe fe-check-circle text-success tx-12"></i></OverlayTrigger></h5>
										<p className="font-13  mb-2 mt-2">
								...
								<div className="d-sm-flex p-3 mt-4 border sub-review-section pb-0">
									<div className="d-flex me-3">
										<Link to="#"><img className="media-object brround avatar-md" alt="64x64" src={Imagesdata("faces5")} /> </Link>
									</div>
									<div className="media-body">
										<h5 className="mt-0 mb-1 font-weight-semibold">Edward
											<OverlayTrigger className="tx-14 ms-0" placement="top" overlay={<Tooltip >Verified</Tooltip>}><i className="fe fe-check-circle text-success tx-12"></i></OverlayTrigger>
											<span className="tx-14 ms-2"> 4 <i className="fa fa-star text-warning"></i></span>
										</h5>
										<p className="font-13  mb-2 mt-2">
											Lorem ipsum dolor sit amet, quis Neque porro quisquam est, nostrud exercitation ullamco laboris   commodo consequat.
										</p>
								...
								<div className="d-sm-flex p-3  mt-4 sub-review-section border subsection-color br-tl-0 br-tr-0">
									<div className="d-flex me-3">
										<Link to="#"><img className="media-object brround avatar-md" alt="64x64" src={Imagesdata("faces6")} /> </Link>
									</div>
									<div className="media-body">
										<h5 className="mt-0 mb-1 font-weight-semibold">Camila cabello <OverlayTrigger className="tx-14 ms-0" placement="top" overlay={<Tooltip >Verified</Tooltip>}><i className="fe fe-check-circle text-success tx-12"></i></OverlayTrigger></h5>
										<p className="font-13  mb-2 mt-2">
											Lorem ipsum dolor sit amet nostrud exercitation ullamco laboris   commodo consequat.
										</p>
										<Link to="#" className="me-2 mt-1"><Badge bg="primary"><span className="me-1 fe fe-thumbs-up tx-11"></span>Helpful</Badge></Link>
				...
				<Col xxl={3} xl={12} lg={12} md={12}>
					...
					<Card className="custom-card overflow-hidden">
						...
						<Card.Body>
							<div className="text-center">
								<Link to={`${import.meta.env.BASE_URL}advancedui/blogpages/blogdetails`}><img className="card-img-top w-100 w-100 rounded-5" src={Imagesdata("photos11")} alt="" /></Link>
						...
						<Card.Body>
							<ListGroup className="mb-0">
								<ListGroup.Item className="d-flex border-0 pt-3 px-0">
									<img src={Imagesdata("photos22")} className="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img" />
									<div className="">
								...
								<ListGroup.Item className="d-flex border-0 px-0">
									<img src={Imagesdata("photos23")} className="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img" />
									<div className="">
								...
								<ListGroup.Item className="d-flex pb-3 border-0 px-0">
									<img src={Imagesdata("photos24")} className="avatar rounded-5 avatar-lg me-3 my-auto" alt="avatar-img" />
									<div className="">
