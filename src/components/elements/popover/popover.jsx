...
import { popoverData, popoverHeading, popoverBody } from '../../../common/commondata';
											...
											{popoverData.map((item, k) => (
												<Col sm={6} lg={3} className="mg-t-30 mg-lg-t-0" key={k}>
													<OverlayTrigger
														...
														overlay={
															<Popover className='popover' id={`popover-positioned-${item.placement}`} style={{ margin: "0px" }}>
											...
											{popoverHeading.map((item, k) => (
												<Col sm={6} lg={3} className="mg-t-30 mg-sm-t-0" key={k}>
													<OverlayTrigger
														...
														placement={item.placement}
														overlay={
															<Popover className='popover-head' id={`popover-positioned-${item.placement}`} style={{ margin: "0px" }}>
																<Popover.Header className={item.class} as="h3">{item.heading}</Popover.Header>
																<Popover.Body>
																	Vivamus sagittis lacus vel augue laoreet rutrum faucibus.
																</Popover.Body>
															</Popover>
