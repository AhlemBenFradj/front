...
import { button } from '../../../common/commondata';
const radios = [
				...
				<Col lg={12} md={12}>
					<Card id="button1">
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">Predefined button styles, each serving its own semantic purpose.</p>
							...
							<div className="text-wrap">
								<div className="example">
									...
									<Row className="row-xs wd-xl-80p">
										{button.map((buttons) => (
											<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2" key={Math.random()}>
												<Button variant={buttons.color} className="btn-block">{buttons.heading}</Button>
											</Col>
										))}
									</Row>
								</div>
							...
							<div className="text-wrap">
								<div className="example">
									<Row className="row-xs wd-xl-80p">
										{button.map((buttons) => (
											<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2" key={Math.random()}>
												<Button variant={buttons.color} className="btn-block" disabled>{buttons.heading}</Button>
											</Col>
										))}
									</Row>
								</div>
							...
							<div className="text-wrap">
								<div className="example">
									<Row className="row-xs wd-xl-80p">
										{button.map((buttons) => (
											<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2" key={Math.random()}>
												<Button variant={`${buttons.color}-gradient`} className="btn-block">{buttons.heading}</Button>
											</Col>
										))}
									</Row>
								</div>
...
{button.map((buttons)=>(
	<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2"  key={Math.random()}>
		<Button variant={&#60{buttons.color}-gradient} className="btn-block">{buttons.heading}</Button>
	</Col>
))}	
</Row>
</div>
							...
							<div className="text-wrap">
								<div className="example">
									<Row className="row-xs wd-xl-80p">
										{button.map((buttons) => (
											<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2" key={Math.random()}>
												<Button variant={`outline-${buttons.color}`} className="btn-block">{buttons.heading}</Button>
											</Col>
										))}
									</Row>
								</div>
...
{button.map((buttons)=>(
	<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2"  key={Math.random()}>
		<Button variant={outline-&#60{buttons.color}} className="btn-block">{buttons.heading}</Button>
	</Col>
))}	
</Row>
</div>
							...
							<div className="text-wrap">
								<div className="example">
									<Row className="row-xs wd-xl-80p">
										{button.map((buttons) => (
											<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2" key={Math.random()}>
												<Button variant={buttons.color} className="btn-rounded btn-block">{buttons.heading}</Button>
											</Col>
										))}
									</Row>
								</div>
							...
							<div className="text-wrap">
								<div className="example">
									<Row className="row-xs wd-xl-80p">
										{button.map((buttons) => (
											<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2" key={Math.random()}>
												<Button variant={`outline-${buttons.color}`} className="btn-rounded btn-block">{buttons.heading}</Button>
											</Col>
										))}
									</Row>
								</div>
...
{button.map((buttons)=>(
	<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0 mt-2"  key={Math.random()}>
		<Button variant={outline-&#60{buttons.color}} className="btn-rounded btn-block">{buttons.heading}</Button>
	</Col>
))}	
</Row>
</div>
				...
				<Col lg={12} md={12}>
					<Card>
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">A basic button with added loaders...</p>
				...
				<Col lg={6} md={12} xl={6}>
					<Card>
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">A basic button with added icons.</p>
				...
				<Col lg={6} md={12} xl={6}>
					<Card id="button5">
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">It is Very Easy to Customize and it uses in your website
								apllication....</p>
				...
				<Col lg={6} md={12} xl={6}>
					<Card>
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">A basic button with sizes</p>
				...
				<Col lg={6} md={12} xl={6}>
					<Card id="button6">
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">A basic button with Width sizes</p>
				...
				<Col lg={12} md={12} xl={12}>
					<Card>
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">A basic button with block sizes</p>
					...
					<Card>
						<Card.Body>
							...
							<div className="">
								<div className="example">
									<div className="">
										<div className='d-sm-flex d-grid' value={value} onChange={handleChange}>
...
<div className="">
	<Row>
		<div className="btn-list" value={value} onChange={handleChange}>
			<ToggleButton variant='primary' value={1} className="mb-1 me-1">Toggle button</ToggleButton>
			<ToggleButton variant='primary' value={2} className="mb-1 me-1" active>Active toggle button</ToggleButton>
			<ToggleButton variant='primary' value={3} className="mb-1 me-1" disabled >Disabled toggle button</ToggleButton>
		</div>
										...
										<Col sm={6} md={3} className="mg-t-10 mg-sm-t-0">
											<Dropdown className="">
												...
												<Dropdown.Menu>
													...
													<Dropdown.Item >Activity Logs</Dropdown.Item>
