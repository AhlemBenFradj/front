					...
					<Card>
						<Card.Body className="">
							...
							<div>
								...
								<ListGroup className="list-group-horizontal-xl mb-3">
									<ListGroup.Item>An item</ListGroup.Item>
									<ListGroup.Item>A second item</ListGroup.Item>
									<ListGroup.Item>A third item</ListGroup.Item>
								</ListGroup>
									...
									<ListGroup>
											...
											<div className="media">
												<div className="d-flex mg-r-10 wd-50">
													<img className="me-4 rounded-circle avatar-md"
														src={Imagesdata("faces17")} alt="avatar" />
												</div>
										...
										<ListGroup.Item className="pd-y-20">
											<div className="media">
												<div className="d-flex mg-r-10 wd-50">
													<img className="me-4 rounded-circle avatar-md"
														src={Imagesdata("faces5")} alt="avatar" />
												</div>
												<div className="media-body">
													<div className="media-body d-flex">
										...
										<ListGroup.Item className="pd-y-20">
											<div className="media">
												<div className="d-flex mg-r-10 wd-50">
													<img className="me-4 rounded-circle avatar-md"
														src={Imagesdata("faces12")} alt="avatar" />
												</div>
												<div className="media-body">
													<div className="media-body d-flex">
