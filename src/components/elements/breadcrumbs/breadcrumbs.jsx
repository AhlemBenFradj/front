				...
				<Col lg={12} md={12}>
					<Card className="custom-card" id="basic">
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">The example below is the basic styling of the breadcrumb from Bootstrap.</p>
				...
				<Col lg={12} md={12}>
					<Card className="custom-card" id="custom">
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">The example below is the custom styling of the breadcrumb used by this template.</p>
							<div className="text-wrap">
								<div className="example">
				...
				<Col lg={12} md={12}>
					<Card className="custom-card" id="divider">
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">The example below is the custom styling of the breadcrumb using different divider.</p>
				...
				<Col lg={12} md={12}>
					<Card className="custom-card" id="center">
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">The example below is the center aligment of the breadcrumb</p>
				...
				<Col lg={12} md={12}>
					<Card className="custom-card" id="right">
						<Card.Body>
							...
							<p as='p' className="text-muted card-sub-title">The example below is the Right aligment of the breadcrumb</p>
