...
import { Brand, children, Electronics, Extra, Mens, Type, women } from '../../../../common/commondata';
...
const Shop = ({ local_varaiable, AddToCart }) => {
	...
	return (
		...
		<div>
			<Pageheader titles="Ecommerce" active="Products" />
									...
									<Card.Body className="h-100">
										...
										<div className="text-center pt-3">
											...
											<span className="tx-15 ms-auto">
												...
												<i className="ion ion-md-star-outline text-warning me-1	"></i>
											</span>
											<h4 className="h5 mb-0 mt-2 text-center fw-bold text-danger">${idx.newprice}<span
												className="text-muted fw-normal tx-13 ms-1 prev-price d-inline-block">${idx.oldprice}</span>
											</h4>
										</div>
									</Card.Body>
								</Card>
