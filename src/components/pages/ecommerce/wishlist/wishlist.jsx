								...
								<Card className="item-card ">
									<Card.Body className="pb-0">
										<div className="text-center zoom">
											<Link to={`${import.meta.env.BASE_URL}pages/ecommerce/productdetails/${idx.id}`} onClick={() => { ProductReduxData(idx.id) }}><img className="w-100 rounded-5" src={idx.preview} alt="img" /></Link>
										</div>
