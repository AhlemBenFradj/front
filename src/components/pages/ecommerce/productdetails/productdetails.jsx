...
import { productData1 } from "../../../../common/commondata";
import { useParams } from "react-router-dom";

import shirt5 from "../../../../assets/img/ecommerce/13.png";
import shirt2 from "../../../../assets/img/ecommerce/14.png";
import shirt3 from "../../../../assets/img/ecommerce/15.png";
import shirt4 from "../../../../assets/img/ecommerce/16.png";
import shirt1 from "../../../../assets/img/ecommerce/17.png";
import { AddToCart } from "../../../../common/redux/action";
import { PODUCTDATA } from "../../../../common/commondata";
		...
		<div>
						...
						<Card.Body className="h-100">
							<Row className="row-sm ">
								...
								<Col xl={7} lg={12} md={12} className="details mt-4 mt-xl-0">
									...
									<h6 className="price">
										current price: <span className="h3 ms-2">${defaultData && defaultData.newprice}</span>
									</h6>
									...
									<div className="action mt-5">
										...
										<Link to={`${import.meta.env.BASE_URL}pages/ecommerce/cart`} onClick={() => { AddToCart(defaultData.id), log }}>
			...
			<Row className="related-products-ltr-l">
				{productData1.map((idx) => (
					<Col lg={3} className="col-md-6 col-sm-6" key={Math.random()}>
						<Card className="item-card">
							...
							<div className="text-center border-top py-3 px-2 ">
								<Link to={`${import.meta.env.BASE_URL}pages/ecommerce/shop`} className="btn btn-primary me-2">
									{" "}
									View More
								</Link>
								<Link
