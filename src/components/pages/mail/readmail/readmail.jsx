						...
						<Card.Body>
							<div className="email-media">
								<div className="mt-0 d-sm-flex">
									<img className="me-2 rounded-circle avatar-xl" src={Imagesdata("faces6")} alt="avatar" />
							...
							<div className="eamil-body mt-5">
								...
								<div className="email-attch">
									<div className="float-end">
										<Link to="#"><i className="bx bxs-download tx-18"></i></Link>
									</div>
									<p className='d-flex'>3 Attachments<Link to="#" className='ms-3'> View All Images</Link></p>
									<div className="emai-img">
										<div className="d-sm-flex">
											<div className=" m-2">
												<Link to="#"><img className="wd-150 mb-2 rounded-3" src={Imagesdata("photos1")} alt="placeholder image" /></Link>
												<h6 className="mb-3 mb-lg-0">1.jpg <small className="text-muted">12kb</small></h6>
											</div>
											<div className="m-2">
												<Link to="#"><img className="wd-150 mb-2 rounded-3" src={Imagesdata("photos2")} alt="placeholder image" /></Link>
												<h6 className="mb-3 mb-lg-0">2.jpg <small className="text-muted">18kb</small></h6>
											</div>
											<div className="m-2">
												<Link to="#"><img className="wd-150 mb-2 rounded-3" src={Imagesdata("photos3")} alt="placeholder image" /></Link>
