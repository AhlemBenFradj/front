...
import { LightboxGalleryChat1 } from '../../../common/LightGallery';

const FriendData = [
	{ id: 1, image: Imagesdata("faces1"), username: 'James Thomas', role: 'Web designer' },
	{ id: 2, image: Imagesdata("faces3"), username: 'Reynante Labares', role: 'Web designer' },
	{ id: 3, image: Imagesdata("faces4"), username: 'Owen Bongcaras', role: 'Web designer' },
	{ id: 4, image: Imagesdata("faces8"), username: 'Stephen Metcalfe', role: 'Administrator' },
	{ id: 5, image: Imagesdata("faces2"), username: 'Socrates Itumay', role: 'Project Manager' },
	{ id: 6, image: Imagesdata("faces5"), username: 'Florinda Carasco', role: 'Team Leader' },
	{ id: 7, image: Imagesdata("faces7"), username: 'Zula Mclaughin', role: 'App Developer' },
	{ id: 8, image: Imagesdata("faces9"), username: 'Alina Bernier', role: 'Administrator' }
]
				...
				<Col lg={8}>
					...
					<Card>
						<Card.Body>
							...
							<Tab.Container className='tabs-menu ' id="left-tabs-example" defaultActiveKey="first">
								...
								<Tab.Content className='border border-top-0 p-4 br-dark'>
									<Tab.Pane eventKey="first">
										...
										<p className="m-b-5">Hi I'm Seif Eddine,has been the industry's standard dummy
