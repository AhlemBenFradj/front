						...
						<Card.Body>
							...
							<div>
								<div className="d-flex flex-row bg-gray-200 ht-100 mg-b-20">
									<div className="pd-10 bg-gray-400 align-self-start">
										Flex item 1
									</div>
									<div className="pd-10 bg-gray-500 align-self-center">
										Flex item 2
									</div>
									<div className="pd-10 bg-gray-600 align-self-end">
										Flex item 3
									</div>
									<div className="pd-10 bg-gray-700 align-self-stretch">
										Flex item 4
									</div>
								</div>
							</div>
						...
						<Card.Body>
							...
							<div>
								<div className="d-flex bg-gray-200">
									...
									<div className="pd-10 bg-gray-600 flex-fill">
										Flex item
									</div>
								</div>
							</div>
				...
				<Col md={12} xl={12} xs={12} sm={12}>
					<Card className="flex-card">
						<Card.Body>
							...
							<div>
								<div className="d-flex bg-gray-200">
									<div className="pd-10 bg-gray-400 flex-grow-1">
										Flex item
									</div>
									<div className="pd-10 bg-gray-500">
										Flex item
						...
						<Card.Body>
							...
							<div>
								<div className="d-flex bg-gray-200">
									...
									<div className="pd-10 bg-gray-600 mg-l-auto">
										Third flex item
									</div>
								</div>
							</div>
