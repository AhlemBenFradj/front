...
import {SwitcherAction, changePrimaryColor, darkPrimaryColor, transparentPrimaryColor, transparentBackground, BGImagePrimaryColor } from '../../common/redux/action';
    ...
    <div>
      <div className="switcher-wrapper">
        <div className="demo_changer">
          <div className="form_holder sidebar-right1 px-0">
            <Scrollbar className="hor-scroll">
              <div className="row mx-0">
                <div className="predefined_styles px-0">
                    ...
                    <div className="skin-body">
                      <div className="switch_section">
                        ...
                        <div className="switch-toggle d-flex mt-2">
																...
																<div className="">
																	<input className="input-transparent-color-picker color-bg-transparent" defaultValue="#eee" id="transparentBgColorID"
                               type="color" data-id5="body" data-id6="theme" data-id9="transparentcolor" name="transparentBackground" onChange={(ele) => { transparentBackground(ele.target.value) }} />
																</div>
															</div>
                      </div>
                    </div>
                  ...
                  <div className="swichermainleft">
                    ...
                    <div className="switch_section">
                      <div className="switch-toggle d-flex">
                        ...
                        <div className="onoffswitch2"><input type="radio" name="onoffswitchBody" id="myonoffswitch07" className="onoffswitch2-checkbox" onClick={() => { SwitcherAction('DefaultBody') }} defaultChecked="true" />
