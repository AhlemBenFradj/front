          ...
          <div className="main-sidebar-header active">
            ...
            <Link className='desktop-logo logo-dark active' to={`${import.meta.env.BASE_URL}indexpage/`}>
              <img
                ...
                alt="logo"
              /></Link>
            <Link className='logo-icon mobile-logo icon-light a' to={`${import.meta.env.BASE_URL}indexpage/`}>
              <img
            ...
            <div className="app-sidebar__user clearfix">
              <div className="dropdown user-pro-body">
                <div className="main-img-user avatar-xl">
                  <img alt="user-img" src={Imagesdata("faces6")} /><span className="avatar-status profile-status bg-green"></span>
                </div>
                <div className="user-info">
                  <h4 className="fw-semibold mt-3 mb-0">{outPut.firstName == undefined ? "Seif" : outPut.firstName} {outPut.lastName == undefined ? "Eddine" : outPut.lastName}</h4>
